...
void stk_push(stack_t **head, unsigned int number);
void stk_pall(stack_t **head, unsigned int number);
void stk_pint(stack_t **head, unsigned int number);
int execute(char *content, stack_t **head, unsigned int line_cnt, FILE *file);
...
void stk_rotl(stack_t **head, unsigned int line_cnt);
...
void stk_stack(stack_t **head, unsigned int line_cnt);
#endif